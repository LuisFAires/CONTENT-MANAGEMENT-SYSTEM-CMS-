...
<div id="Cadastrar" class="contentDiv padding2">
    <form method="post" enctype="multipart/form-data" action="insert.php">
        ...
        <input id="titulo" class="formCadastro width100" type="text" name="titulo" require_onced><br>
        <label for="texto">Texto</label><br>
        <textarea id="texto" class="formCadastro width100" name="texto"require_onced></textarea ><br>
        ...
        <input id="cor1" class="formCadastro width100" type="color" name="cor1" value="#ffffff" require_onced><br>
        <label for="cor2">Cor fonte secundaria</label><br>
        <input id="cor2" class="formCadastro width100" type="color" name="cor2" value="#00ff00" require_onced><br><br>
...
<div id="Configurações" class="contentDiv padding2">
    <form method="post" enctype="multipart/form-data" action="logoupdate.php">
        ...
        <input id="logo" class="formCadastro width100" type="file" name="logo" require_onced><br>
    ...
    <form method="post" enctype="multipart/form-data" action="confupdate.php">
        ...
        <input id="Nome" class="formCadastro width100" type="text" name="Nome" value="<?php echo $Nome?>"require_onced><br>
        <label for="Descrição">Descrição</label><br>
        <textarea id="Descrição" class="formCadastro width100" name="Descrição"require_onced><?php echo $Descrição?></textarea ><br>
        <label for="Política">Política de privacidade</label><br>
        <textarea id="Política" class="formCadastro width100" name="Política"require_onced><?php echo $Política?></textarea ><br>
        <label for="Sobre">Sobre:</label><br>
        <textarea id="Sobre" class="formCadastro width100" name="Sobre"require_onced><?php echo $Sobre?></textarea ><br>
        <label for="Botões">Botões inicio</label><br>
        <textarea id="Botões" class="formCadastro width100" name="Botões"require_onced><?php echo $Botões?></textarea ><br>
        ...
        <select type="checkbox" id="manutecao" class="formCadastro width100" name="manutecao"require_onced>
